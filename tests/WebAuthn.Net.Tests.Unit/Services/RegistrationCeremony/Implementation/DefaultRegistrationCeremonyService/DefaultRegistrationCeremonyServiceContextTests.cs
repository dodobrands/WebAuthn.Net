...
public class DefaultRegistrationCeremonyServiceContextTests : AbstractRegistrationCeremonyServiceTests
{
    ...
    [Test]
    public async Task DefaultRegistrationCeremonyService_CallsCommitOnContext_WhenBeginCeremonyInvoked()
    {
        var userId = WebEncoders.Base64UrlDecode("AAAAAAAAAAAAAAAAAAAAAQ");
        ContextFactory.ResetMetrics();

        await RegistrationCeremonyService.BeginCeremonyAsync(
    ...
    [Test]
    public async Task DefaultRegistrationCeremonyService_CallsCommitOnContext_WhenCompleteCeremonyInvoked()
    {
        var userId = WebEncoders.Base64UrlDecode("AAAAAAAAAAAAAAAAAAAAAQ");
