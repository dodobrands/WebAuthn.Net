...
A production-ready, easy-to-use, extensible implementation of the [WebAuthn Level 3 standard](https://www.w3.org/TR/webauthn-3), passing the [FIDO conformance test](https://fidoalliance.org/certification/functional-certification/conformance/), for the server side of web applications on .NET 8 and .NET 9.
...
- [.NET SDK 8.0.413+](https://dotnet.microsoft.com/en-us/download/dotnet/8.0)
- [.NET SDK 9.0.304+](https://dotnet.microsoft.com/en-us/download/dotnet/9.0)
