...
/// <summary>
///     PostgreSQL-based storage model for storing <see cref="UserCredentialRecord" />.
/// </summary>
public class PostgreSqlUserCredentialRecord
{
    /// <summary>
    ///     Unique identifier of the record in PostgreSQL.
    /// </summary>
    [Required]
    ...
    ///     </para>
    ///     <para>For storage in PostgreSQL, the values are transformed into json ('jsonb' data type).</para>
    /// </remarks>
    ...
    /// <summary>
    ///     Creates <see cref="PostgreSqlUserCredentialRecord" />.
    /// </summary>
    /// <param name="credential">Credential record bound to a user account.</param>
    /// <param name="id">Unique identifier of the record in PostgreSQL.</param>
    ...
    /// <returns>An instance of <see cref="PostgreSqlUserCredentialRecord" />.</returns>
