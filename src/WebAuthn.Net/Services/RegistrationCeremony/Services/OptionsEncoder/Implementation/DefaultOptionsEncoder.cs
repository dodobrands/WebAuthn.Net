...
namespace WebAuthn.Net.Services.RegistrationCeremony.Services.OptionsEncoder.Implementation;

[SuppressMessage("ReSharper", "MemberCanBePrivate.Global")]
[SuppressMessage("ReSharper", "StaticMemberInGenericType")]
public class DefaultOptionsEncoder<TContext>
    : IOptionsEncoder<TContext> where TContext : class, IWebAuthnContext
{
