...
/// <summary>
///     Service that computes origin at runtime based on data in <see cref="HttpContext" />.
/// </summary>
public interface IRelyingPartyOriginProvider
{
    /// <summary>
    ///     Asynchronously computes and returns the origin value for the current request based on data in <see cref="HttpContext" />.
    /// </summary>
    ...
    /// <returns>Origin for the current request.</returns>
