...
{
    /// <summary>
    ///     A flag controlling if the <a href="https://www.w3.org/TR/webauthn-3/#relying-party">Relying Party</a> wants to accept only keys from a trusted execution environment (TEE). Defaults to <see langword="true" />.
    /// </summary>
