...
public class AuthenticationPublicKeyCredentialDescriptorJSON
{
    /// <summary>
    ///     Constructs <see cref="AuthenticationPublicKeyCredentialDescriptorJSON" />.
    /// </summary>
    ...
    /// </param>
    [JsonConstructor]
    public AuthenticationPublicKeyCredentialDescriptorJSON(string id, string type, string[]? transports)
    {
        Id = id;
        Type = type;
