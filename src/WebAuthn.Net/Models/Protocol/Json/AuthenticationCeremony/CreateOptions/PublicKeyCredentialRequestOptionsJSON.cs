...
public class PublicKeyCredentialRequestOptionsJSON
{
    ...
    ///     </para>
    ///     <para>
    ///         The extensions framework is defined in <a href="https://www.w3.org/TR/webauthn-3/#sctn-extensions">WebAuthn Extensions</a>. Some extensions are defined in <a href="https://www.w3.org/TR/webauthn-3/#sctn-defined-extensions">Defined Extensions</a>; consult the IANA
    ///         "WebAuthn Extension Identifiers" registry <a href="https://www.iana.org/assignments/webauthn/webauthn.xhtml">[IANA-WebAuthn-Registries]</a> established by <a href="https://www.rfc-editor.org/rfc/rfc8809">[RFC8809]</a> for an up-to-date list of registered
