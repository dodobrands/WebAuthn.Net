...
/// </summary>
/// <remarks>
///     <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#dictionary-assertion-options">Web Authentication: An API for accessing Public Key Credentials Level 3 - §5.5. Options for Assertion Generation</a>
/// </remarks>
public class PublicKeyCredentialRequestOptions
{
    ...
    ///     <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#public-key-credential-source-rpid">rpId</a> of the <a href="https://www.w3.org/TR/credential-management-1/#concept-credential">credential</a> to be used for the
    ...
    ///     by the authenticator. Values SHOULD be taken from the <a href="https://www.iana.org/assignments/webauthn/webauthn.xhtml">IANA "WebAuthn Attestation Statement Format Identifiers" registry</a> established by <a href="https://www.rfc-editor.org/rfc/rfc8809.html">RFC 8809</a>.
    ///     Values are ordered from most preferable to least preferable. This parameter is advisory and the <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#authenticator">authenticator</a> MAY use an attestation statement not enumerated in this parameter.
    /// </param>
    ...
    /// <exception cref="ArgumentException"><paramref name="rpId" /> contains surrogate pairs (it is not a valid instance of <a href="https://webidl.spec.whatwg.org/#idl-USVString">USVString</a>)</exception>
    ...
    /// <summary>
    ///     <para>
    ///         The <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#relying-party">Relying Party</a> MAY use this OPTIONAL member to provide <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#client-extension-input">client extension inputs</a> requesting
    ///         additional processing by the <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#client">client</a> and <a href="https://www.w3.org/TR/2023/WD-webauthn-3-20230927/#authenticator">authenticator</a>.
    ///     </para>
    ///     <para>
