...
/// <summary>
///     MySQL-based storage model for storing <see cref="UserCredentialRecord" />.
/// </summary>
public class MySqlUserCredentialRecord
{
    /// <summary>
    ///     Unique identifier of the record in MySQL.
    /// </summary>
    [Required]
    [MaxLength(16)]
    ...
    /// <summary>
    ///     Creates <see cref="MySqlUserCredentialRecord" />.
    /// </summary>
    /// <param name="credential">Credential record bound to a user account.</param>
    /// <param name="id">Unique identifier of the record in MySQL.</param>
    ...
    /// <returns>An instance of <see cref="MySqlUserCredentialRecord" />.</returns>
