...
/// <summary>
///     Default implementation of <see cref="ICredentialStorage{TContext}" /> for Microsoft SQL Server-based storage.
/// </summary>
...
{
    /// <summary>
    ///     Constructs <see cref="DefaultSqlServerCredentialStorage{TContext}" />.
    /// </summary>
...
WHERE UserHandle = @userHandle AND CredentialId = @credentialId AND RpId = @rpId;",
        ...
        var updated = SqlServerUserCredentialRecord.Create(credential, recordIdToUpdate.Value, default, updatedAt);
