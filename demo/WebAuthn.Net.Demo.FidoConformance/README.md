...
1. Install .NET SDK versions [.NET SDK 8.0.423+](https://dotnet.microsoft.com/en-us/download/dotnet/8.0), [.NET SDK 9.0.316+](https://dotnet.microsoft.com/en-us/download/dotnet/9.0) and [.NET SDK 10.0.302+](https://dotnet.microsoft.com/en-us/download/dotnet/10.0).
