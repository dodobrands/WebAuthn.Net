...
1. Install .NET SDK versions [6.0.425+](https://dotnet.microsoft.com/en-us/download/dotnet/6.0) and [8.0.405+](https://dotnet.microsoft.com/en-us/download/dotnet/8.0).
