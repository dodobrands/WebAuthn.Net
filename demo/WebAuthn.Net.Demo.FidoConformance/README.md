...
1. Install .NET SDK versions [8.0.410+](https://dotnet.microsoft.com/en-us/download/dotnet/8.0) and [9.0.300+](https://dotnet.microsoft.com/en-us/download/dotnet/9.0).
